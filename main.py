            ...
            for u in users:
                if username == u[1]:
                    ...
                    if encoded_pass == u[2]:
                        _pass = True 
                        break
            if user and _pass: break    
            elif not user: print(Fore.RED+'User not found.'+Style.RESET_ALL); continue
            elif not _pass: print(Fore.RED+'Password is incorrect!'+Style.RESET_ALL); continue
        system("cls")
            ...
            while True:
                ...
                if user_select == 1:
                    ...
                    for d in data:
                        ...
                        table.add_row([d['course'], d['capacity'], d['remaining']])
                    ...
                    courses = [d['course'] for d in data]
            ...
            while True:
                ...
                if user_select == 1:
                    ...
                    while True : #chek darse tekrar
                        ...
                        data[k] = input(f'Enter {k}: ') # ro kilid balai hharkat kon va meqdar begir
                        if k == 'course':
                            courses = map(lambda e: e[0], HandleFile(r"./database/courses.csv").read_info())
                            if data[k] in courses:
